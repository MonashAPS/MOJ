...
The protocol itself is documented in [architecture](https://moj.monashaps.com/reference/architecture), the
problem format in [problem format](https://moj.monashaps.com/problems/format).
